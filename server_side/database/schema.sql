...
FROM calls c
LEFT JOIN users creator ON c.creator_userid = creator.userid
...
LEFT JOIN user_presence up ON f.friend_userid = up.userid
...
CREATE INDEX IF NOT EXISTS idx_game_scores_userid ON game_scores(userid);
CREATE INDEX IF NOT EXISTS idx_game_scores_played_at ON game_scores(played_at);
CREATE INDEX IF NOT EXISTS idx_calls_creator_userid ON calls(creator_userid);
...
CREATE INDEX IF NOT EXISTS idx_friends_friend_userid ON friends(friend_userid);
CREATE INDEX IF NOT EXISTS idx_friend_requests_sender_userid ON friend_requests(sender_userid);
CREATE INDEX IF NOT EXISTS idx_friend_requests_receiver_userid ON friend_requests(receiver_userid);
